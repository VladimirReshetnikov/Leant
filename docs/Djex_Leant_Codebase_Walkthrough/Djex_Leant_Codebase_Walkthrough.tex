...
\filepath{synthesis/internal/Language/Haskell/Synthesis/Internal/Semantic/Length/SMTLib/Session.hs} & V4 ready-worker identity with one direct complete Length-policy occurrence, a strict post-probe query-only policy, process-owned limit projection, plan-owned replay inputs, scoped serial ordinals, poisoning, and cleanup. \\
