...
\midrule
\endhead
\filepath{src/Leant/Synth/Engine.hs} & Synthesis translation and search, Exference run authority, typed semantic sidecars, opaque renderer/verification provenance, and exact-origin rerender mechanics. \\
