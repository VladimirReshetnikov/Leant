...
\filepath{src/Leant/Synth/Length/Contract/File.hs} & Exact contract-only version 1 root reusing the compatibility contract grammar and limits, with no execution-policy fields. \\
