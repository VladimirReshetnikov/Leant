...
\midrule
\endhead
\filepath{src/Leant/Synth/Engine.hs} & Synthesis translation and search, Exference run authority, typed semantic sidecars, and opaque renderer/verification provenance. \\
...
\filepath{src/Leant/Synth/Length/Handoff.hs} & Verified exact-origin correspondence, exact family/provider resolution, and candidate-specific Djex Length problem sealing. \\
