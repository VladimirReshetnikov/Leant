...
\def\DjexBase{https://github.com/VladimirReshetnikov/Djex/blob/f50b5eac86726c7530d95e48c27101b7c0fa25c9/}
\def\LeantBase{https://github.com/VladimirReshetnikov/Leant/blob/425131c6338d51f7b16189fdc0610da82e9cb641/}
...
\textbf{Djex snapshot} & \commitid{f50b5eac86726c7530d95e48c27101b7c0fa25c9} \\
\textbf{Leant snapshot} & \commitid{425131c6338d51f7b16189fdc0610da82e9cb641} \\
\textbf{Relationship} & Leant's \filepath{lib/Djex} submodule is pinned to the same Djex revision. \\
\textbf{Prepared} & August 10, 2026 \\
\end{tabularx}
\end{tcolorbox}
\vfill
...
\filepath{src/Leant/Synth/Length/Configuration.hs} & Opaque reusable execution/replay policy with independent optional origin-probe, finite input-box, complete applicable-domain, and non-vacuous positive-ordering policies; total assembly from validated Djex authorities; the cumulative root-extrema, root-monus, Boolean finite-union, and atomic-branching applicable-domain builders; sealed digest-expectation and four-way executable-launch classifiers; literal legacy, descriptor-bound, descriptor-bound effective-ID executable-access, and descriptor-bound execve-check executable-access constructors; and policy-plus-request-contract ranking/assessment entrances for both the scalar and SpinePair domains. \\
\filepath{src/Leant/Synth/Length/Configuration/File.hs} & Closed, bounded JSON decoder for startup versions 1--32: literal v1--v30 cascade through the scalar v29 and binary-product v30 Boolean finite-union roots, followed by scalar v31 and binary-product v32 atomic-branching roots. The version pairs select literal-ceiling, runtime-unscoped usable-work, relational, scoped usable-work, strict-relational, root-quotient, root-extrema, root-monus, Boolean finite-union, atomic-branching finite-union, sealed-main-image, two-point source-access, or execve-check policy without revising older schemas; v31/v32 are handled only by the later atomic-branching decoder; v33 remains unsupported. Its disabled owner retains one strict validated policy beside one lazy fixed contract, with no copied source-derived pin flag; activation checks only the policy and releases that pair. \\
...
\lpath{test-unit/Spec.hs} is a broad unit suite covering JSON, classifiers, snapshot metadata and publication, replay decisions, fragment parsing and analysis, provider queries and cache behavior, Djex translations, assignment fitting, rendering, candidate grouping, and many regressions around rank-N providers and recursive families. On the current branch the suite has grown to 29{,}097 lines and 485 exact \code{testCase} tokens, 484 of which execute as suite cases; its single largest area is the Length/SpinePair behavioral-assessment layer: contract decoding, configuration-file versions, the checked handoff, ranking, post-verification sealing, presentation notes, and live execution against the \code{djex-fake-z3} fixture.
...
\begin{itemize}
  \item Djex pinned tree: \href{https://github.com/VladimirReshetnikov/Djex/tree/f50b5eac86726c7530d95e48c27101b7c0fa25c9}{\nolinkurl{github.com/VladimirReshetnikov/Djex/tree/f50b5eac...}}
  \item Leant pinned tree: \href{https://github.com/VladimirReshetnikov/Leant/tree/425131c6338d51f7b16189fdc0610da82e9cb641}{\nolinkurl{github.com/VladimirReshetnikov/Leant/tree/425131c...}}
