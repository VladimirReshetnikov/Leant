...
\filepath{src/Leant/Synth/Length/Configuration.hs} & Opaque explicit execution/replay policy and sealed digest-expectation presence bridge; contract remains request-owned. \\
\filepath{src/Leant/Synth/Length/Configuration/File.hs} & Closed, bounded version-1 JSON decoder returning a disabled configuration with no copied source-derived pin flag. \\
