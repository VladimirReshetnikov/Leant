...
\def\LeantBase{https://github.com/VladimirReshetnikov/Leant/blob/23671c7321d49c3b04c071d6604ed6b96ff911ee/}
...
\textbf{Leant snapshot} & \commitid{23671c7321d49c3b04c071d6604ed6b96ff911ee} \\
...
The canonical-\code{Prod} path mirrors the scalar ranking and selection stacks through \code{Leant.Synth.Length.SpinePair.Ranking}, \code{Leant.Synth.Length.SpinePair.Ranking.Internal}, \code{Leant.Synth.Length.SpinePair.PostVerification}, \code{Leant.Synth.Length.SpinePair.PostVerification.Internal}, \code{Leant.Synth.Length.SpinePair.Selection}, and \code{Leant.Synth.Length.SpinePair.Selection.Internal}. On the Djex side, \filepath{synthesis/internal/Language/Haskell/Synthesis/Internal/Semantic/Length/SMTLib/Protocol/SpinePair.hs} is deliberately thin: the scalar and product protocol modules now share one phase machine, framing validation, write rendering, and fingerprint construction, parameterized by the \code{LengthSMTLibProtocolIdentity} record in \filepath{.../Semantic/Length/SMTLib/Protocol.hs}. The SpinePair wrapper contributes only what distinguishes the product domain---its schema tags, plan fingerprint role, and exact product-query projections---while its nominal plan, receiver, decoded, retention, rejection, and selection types remain distinct from their scalar siblings, so evidence sealed under one domain cannot be presented under the other even when the rendered wire bytes coincide.
...
\begin{itemize}
  ...
  \item Leant pinned tree: \href{https://github.com/VladimirReshetnikov/Leant/tree/23671c7321d49c3b04c071d6604ed6b96ff911ee}{\nolinkurl{github.com/VladimirReshetnikov/Leant/tree/23671c7...}}
