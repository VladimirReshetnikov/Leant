...
\def\LeantBase{https://github.com/VladimirReshetnikov/Leant/blob/feb234ff770faf2e42106a01f6473c48410f1152/}
...
\textbf{Leant snapshot} & \commitid{feb234ff770faf2e42106a01f6473c48410f1152} \\
...
The focused strict bank runner surface passes 7/7 and explicit Length
assessment integration passes 21/21. The complete strict Leant unit suite
passes 441/441. Strict warning-as-error builds of the test target and complete
project are green; \code{cabal check} and \code{git diff --check} are clean.
Against the pinned Lean 4.31 backend, all 26 golden transcripts pass byte-exact
without update mode or fixture drift; the 26 scripts and 26 golden files are
unchanged.
...
\begin{itemize}
  ...
  \item Leant pinned tree: \href{https://github.com/VladimirReshetnikov/Leant/tree/feb234ff770faf2e42106a01f6473c48410f1152}{\nolinkurl{github.com/VladimirReshetnikov/Leant/tree/feb234f...}}
