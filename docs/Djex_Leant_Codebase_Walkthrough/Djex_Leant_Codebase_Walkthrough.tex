...
\def\LeantBase{https://github.com/VladimirReshetnikov/Leant/blob/fa83ead1bd9670a83440b44e23f80dfb259d683f/}
...
\textbf{Leant snapshot} & \commitid{fa83ead1bd9670a83440b44e23f80dfb259d683f} \\
...
\filepath{src/Leant/Synth/Length/Command.hs} & Exact fixed-order established \code{:synth [-{}-behavior-mode rank|filter] [-{}-length-contract PATH] -{}- TYPE} parser, with ordinary no-option goals left delimiter-free and opaque, plus the separate fixed-order inline parser. Main now gives the inline parser precedence, authorizes its literal filter request, and only then enters the retained bounded clause source. \\
\filepath{src/Leant/Synth/Length/Where.hs} & Leant profiles over Djex's bounded where-clause syntax: two fixed exact-case list models, ASCII input-index admission, and a resolver that builds the complete source-ordered role vector from Lean-translated \code{SlotArrow}-only physical arity before elaboration. The plan, parsed source, and expanded contract remain passive data; Main alone pairs the resolved selection with existing policy authority and one nominal context. \\
...
\begin{itemize}
  ...
  \item Leant pinned tree: \href{https://github.com/VladimirReshetnikov/Leant/tree/fa83ead1bd9670a83440b44e23f80dfb259d683f}{\nolinkurl{github.com/VladimirReshetnikov/Leant/tree/893c4a1...}}
