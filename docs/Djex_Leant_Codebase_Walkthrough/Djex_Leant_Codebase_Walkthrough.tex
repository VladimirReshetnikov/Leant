...
\filepath{synthesis/internal/Language/Haskell/Synthesis/Internal/Semantic/Length/SMTLib/Protocol.hs} & Pure positional Length query protocol and causal write boundaries. \\
...
\filepath{synthesis/internal/Language/Haskell/Synthesis/Internal/Semantic/Length/SMTLib/Session.hs} & V4 ready-worker identity with one direct complete Length-policy occurrence, scoped lease, serial ordinals, marker ownership, query execution, poisoning, replay, and cleanup. \\
