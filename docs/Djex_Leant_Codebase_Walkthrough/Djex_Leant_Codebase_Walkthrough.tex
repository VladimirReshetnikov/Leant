...
\filepath{src/Leant/Synth/Length/Contract/File.hs} & Exact contract-only versioned root: unchanged v1 compatibility grammar and v2 positive-literal Natural modulo, with shared limits and no execution-policy fields. \\
