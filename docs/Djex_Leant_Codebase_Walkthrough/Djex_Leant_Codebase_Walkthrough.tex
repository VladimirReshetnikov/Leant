...
\filepath{src/Leant/Synth/Length/Integration.hs} & Opaque disabled/configured mode, admission--load--activation setup, fixed-contract configured assessment, sanitized fallback, and exact disabled identity. \\
