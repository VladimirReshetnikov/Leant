...
\def\DjexBase{https://github.com/VladimirReshetnikov/Djex/blob/f50ae24c39c380642fa457abd9904b77114843e8/}
\def\LeantBase{https://github.com/VladimirReshetnikov/Leant/blob/859c36cec17cb5c093f7435ac43de1650667695e/}
...
\textbf{Djex snapshot} & \commitid{f50ae24c39c380642fa457abd9904b77114843e8} \\
\textbf{Leant snapshot} & \commitid{859c36cec17cb5c093f7435ac43de1650667695e} \\
...
\filepath{synthesis/src/Language/Haskell/Synthesis/Semantic/Length/SMTLib.hs} & Transient typed QF\_LIA planning, canonical bounded bytes, structurally complete query fingerprint, retained problem-scope projection, exact same-scope fresh-record and retained-sample replay bridges, and model-binding validation. Internally the scalar and product boundaries share one plan sealer, one fingerprint builder over a role/schema/logic vocabulary, and one model reader over each domain's error constructors, while every public query, fingerprint, and error type stays nominally per-domain. \\
