...
\code{binary-product}; the separate one-command contract-file grammar remains
versioned.
...
\code{rankingDomain}; the separate contract-only grammar remains strict and
versioned. The current reference is \code{docs/length-ranking.md}; dated
