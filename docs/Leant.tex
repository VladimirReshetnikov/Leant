...
head, its ordered proper-type arguments, and the contextual body. Malformed,
open, dictionary-dependent, term-indexed, and otherwise unsupported contexts
still discard their complete vector. Provider-prefix fallback keeps metadata
...
proper-type arguments as \code{FExactContext}. Djex checks that semantic
constraint and rendering restores the exact Lean class head. Open, incomplete,
