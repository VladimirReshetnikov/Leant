...
rejected without the configuration option itself.
...
configuration and contract grammars are versioned and strict; the
README documents every version, and the dated reports under
\code{docs/reports/} record the design.  Everything in this paragraph
