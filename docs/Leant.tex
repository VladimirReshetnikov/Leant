...
Its singleton, pairwise, triple, and quadruple open/opaque frontiers grow
quartically and cover every choice through nine independent quantified
...
therefore does not exercise the greater-than-four hypothesis-instantiation
...
current submodule pin, \code{c0c1a461}, follows it with tuple-goal provenance:
...
36{,}491 queue prunes: search continued after the successful candidate and did
...
improves. The current plan family is exhaustive through nine
independent quantified sites; a ten-site five-open/five-opaque goal
