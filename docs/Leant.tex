...
\code{Wide = forall A B C D E : Type, A × B × C × D × E}, so every binder is
...
Djinn occurrence site rather than five nested sites. With Djex
...
truncated. This changes occurrence coverage only: hypothesis instantiation
still stops at four leading binders.
