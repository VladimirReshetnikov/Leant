...
\code{enableLengthRankingApplicableDomainValidation}, and the current
assessments are \code{ApplicableDomainEstablished} and
\code{LengthSpinePairApplicableDomainEstablished}. Presentation uses only
\code{renderLengthApplicableDomainValidationNote} and
\code{renderLengthSpinePairApplicableDomainValidationNote}. Djex keeps the
