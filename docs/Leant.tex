...
applied nominal head with proper-type supplied arguments. Malformed, open,
dictionary-dependent, term-indexed, structural-builtin, and otherwise
unsupported contexts still discard their complete vector. A bounded pre-scan
...
exact Lean class head. Open, incomplete,
