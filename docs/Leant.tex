...
binary-product bank scopes with bounded immutable input stores. Leant does not
import, construct, or consult those stores, and there is no automatic
bank-replay-to-receipt bridge. They are a dormant library foundation, not a
command-local bank or a change to this active batch-local MRU.
...
\code{docs/reports/2026-08-16-explicit-synthesis-lane-outcomes.md}. Dated
