...
outer 12- and 24-group verification frontiers then apply.  Ordinary ranking
retains its historical verifier stop after five accepted groups.  An explicit
...
context survives the command. No engine, verification module, or REPL state
contract changed. The current reference
