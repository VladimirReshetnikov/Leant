...
discovered tactic suggestion that Lean has already checked.  The probe
search prefers a candidate that closes the goal outright and annotates the
suggestion accordingly (\code{closes the goal}, \code{splits into 2
goals}); an \code{intro} suggestion names the binders it would introduce.
