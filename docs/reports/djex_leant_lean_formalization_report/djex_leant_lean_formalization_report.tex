...
every certification claim in this report remains future work.  A companion
study, \emph{Rewriting Leant and Djex in Lean~4}
(\code{docs/Leant\_Djex\_Lean4\_Rewrite\_Analysis/}, 15 August 2026), asks
the complementary question --- not what Lean could certify about the
existing Haskell implementation, but whether the Lean-facing parts should
be reimplemented in Lean itself.}
\end{titlepage}
