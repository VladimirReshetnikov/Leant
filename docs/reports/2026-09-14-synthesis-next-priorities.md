...
| --- | --- | --- |
| 0; accepted | Contextual binder integration. | Final native, public and affected regression gates pass; the tested source, pin and complete release evidence are integrated. Preserve the frozen producing checkout and repeat relevant gates only after a material change. |
