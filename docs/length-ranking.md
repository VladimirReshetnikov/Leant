...
- [Startup configuration file](#startup-configuration-file)
  - [Versions 1 to 22 at a glance](#versions-1-to-22-at-a-glance)
...
a version-1 through version-22 configuration file. Versions 1--3 select scalar
